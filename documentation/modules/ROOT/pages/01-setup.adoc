...
During this tutorial, it will be required to work with different tools for running the exercises included. We have already installed the Web Console operator with those tools. But if you want to use your terminal, please install the following software:
...
We have installed the OpenShift command line terminal with all the CLI that are needed for this laboratory.

.OpenShift command line terminal
image::oc_termina1.png[]

In this terminal, you will be able to execute all the commands.

.Terminal
image::oc_termina2.png[]
...
[TIP]
====
You already have the Argo Rollouts CLI in the OpenShift command line terminal. But if you want to install Argo Rollouts CLI in your local follow the https://argoproj.github.io/argo-rollouts/installation/#kubectl-plugin-installation[official documentation]
====
